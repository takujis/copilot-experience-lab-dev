...
| Day | 体験 |
|---|---|
| 1 | [Copilotに自分の現在地を聞く｜DAY-01](./Copilotに自分の現在地を聞く_DAY-01.md) |
| 2 | [忙しい朝を3分で整理する｜DAY-02](./忙しい朝を3分で整理する_DAY-02.md) |
| 3 | [長いメールスレッドから結論だけを得る｜DAY-03](./長いメールスレッドから結論だけを得る_DAY-03.md) |
| 4 | [会議前の「何を話せばよいか」を作る｜DAY-04](./会議前の「何を話せばよいか」を作る_DAY-04.md) |
| 5 | [Week 1の驚きを言語化する｜DAY-05](./Week%201の驚きを言語化する_DAY-05.md) |

### Week 2：毎日発生する面倒をCopilotに渡す

| Day | 体験 |
|---|---|
| 6 | [未処理メールをまとめて整理する｜DAY-06](./未処理メールをまとめて整理する_DAY-06.md) |
| 7 | [文章を「相手に伝わる形」へ変換する｜DAY-07](./文章を「相手に伝わる形」へ変換する_DAY-07.md) |
| 8 | [メール返信を3パターン作る｜DAY-08](./メール返信を3パターン作る_DAY-08.md) |
| 9 | [会議後のアクションを自分用に再整理する｜DAY-09](./会議後のアクションを自分用に再整理する_DAY-09.md) |
| 10 | [見落としている依頼を探す｜DAY-10](./見落としている依頼を探す_DAY-10.md) |
| 11 | [1日の終わりをCopilotで締める｜DAY-11](./1日の終わりをCopilotで締める_DAY-11.md) |
| 12 | [朝または夕方のプロンプトを定型化する｜DAY-12](./朝または夕方のプロンプトを定型化する_DAY-12.md) |

### Week 3：成果物を「ゼロから作る仕事」を減らす

| Day | 体験 |
|---|---|
| 13 | [既存資料を要約する｜DAY-13](./既存資料を要約する_DAY-13.md) |
| 14 | [複数資料を比較する｜DAY-14](./複数資料を比較する_DAY-14.md) |
| 15 | [箇条書きから文書の初稿を作る｜DAY-15](./箇条書きから文書の初稿を作る_DAY-15.md) |
| 16 | [長い文書をレビューしてもらう｜DAY-16](./長い文書をレビューしてもらう_DAY-16.md) |
| 17 | [Wordからプレゼンテーションの構成を作る｜DAY-17](./Wordからプレゼンテーションの構成を作る_DAY-17.md) |
| 18 | [自社紹介を視覚化する｜DAY-18](./自社紹介を視覚化する_DAY-18.md) |
| 19 | [Excelデータから示唆を得る｜DAY-19](./Excelデータから示唆を得る_DAY-19.md) |

### Week 4：単発の作業から「仕事の流れ」へ広げる

| Day | 体験 |
|---|---|
| 20 | [会議前から会議後までを一連で使う｜DAY-20](./会議前から会議後までを一連で使う_DAY-20.md) |
| 21 | [プロジェクトの状況を横断的に把握する｜DAY-21](./プロジェクトの状況を横断的に把握する_DAY-21.md) |
| 22 | [「最新状況を教えて」を自分の案件で使う｜DAY-22](./「最新状況を教えて」を自分の案件で使う_DAY-22.md) |
| 23 | [役割別のユースケースを作る｜DAY-23](./役割別のユースケースを作る_DAY-23.md) |
| 24 | [自分専用の「鉄板プロンプト」を作る｜DAY-24](./自分専用の「鉄板プロンプト」を作る_DAY-24.md) |
| 25 | [チームでプロンプトを交換する｜DAY-25](./チームでプロンプトを交換する_DAY-25.md) |

### Final Week：自分専用化し、なくなった場合の損失を見える化する

| Day | 体験 |
|---|---|
| 26 | [繰り返し業務を1つ選ぶ｜DAY-26](./繰り返し業務を1つ選ぶ_DAY-26.md) |
| 27 | [軽量Agent Builder体験｜DAY-27](./軽量Agent%20Builder体験_DAY-27.md) |
| 28 | [Copilotなしで行っていた方法と比較する｜DAY-28](./Copilotなしで行っていた方法と比較する_DAY-28.md) |
| 29 | [自分の30日間の価値をまとめる｜DAY-29](./自分の30日間の価値をまとめる_DAY-29.md) |
| 30 | [「明日からCopilotがなくなったら」を考える｜DAY-30](./「明日からCopilotがなくなったら」を考える_DAY-30.md) |
